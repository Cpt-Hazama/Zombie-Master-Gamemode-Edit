...
function MakepOptions()
	...
	catagory:DockMargin(0, 0, 0, 8)
	catagory:SetExpanded(0)
	catagory:SetLabel("Other Settings")
	...
	slider:SetConVar("zm_healthcircle_brightness")
	slider:SetText("Health Circle Brightness")
	slider:SizeToContents()
	slider:Dock(TOP)
	slider:DockMargin(0, 8, 0, 4)
	catagorylist:AddItem(slider)
	...
	slider:SetConVar("zm_cl_scrollspeed")
	slider:SetText("Zombie Master Scroll Speed")
	slider:SizeToContents()
	slider:Dock(TOP)
	slider:DockMargin(0, 8, 0, 4)
	catagorylist:AddItem(slider)
